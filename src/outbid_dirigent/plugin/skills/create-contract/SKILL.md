...
<step id="3">If `.dirigent/test-harness.json` exists, read it. Use its verification_commands and health_checks as verification methods for acceptance criteria. This is how the reviewer will actually test things end-to-end.</step>
